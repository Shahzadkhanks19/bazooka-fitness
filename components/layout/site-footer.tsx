...
const footerCols = [
  ...
  { title: "Programs", links: [["Strength Training", "/programs/strength-training"], ["Personal Training", "/programs/personal-training"], ["Functional Training", "/programs/functional-training"], ["Cardio & Endurance", "/programs/cardio-endurance"], ["Transformation Program", "/programs/transformation-program"], ["Recovery", "/programs/recovery-wellness"], ["Cafe Bazooka", "/cafe-bazooka"]] },
