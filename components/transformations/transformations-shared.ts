...
export const primaryButton = `${buttonBase} border-bazooka-lime bg-bazooka-lime text-black hover:bg-bazooka-lime-hover hover:shadow-[0_0_26px_rgba(182,240,0,.22)] active:bg-bazooka-lime-pressed`;
