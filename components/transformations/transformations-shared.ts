...
export const buttonBase = "group inline-flex h-11 items-center justify-center gap-3 rounded-[4px] border px-5 sm:px-6 text-[10px] font-black uppercase transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0";
export const primaryButton = `${buttonBase} border-bazooka-lime bg-bazooka-lime text-black hover:bg-bazooka-lime-hover hover:shadow-[0_0_26px_rgba(182,240,0,.22)]`;
