...
export const buttonClass = "inline-flex h-11 items-center justify-center gap-3 rounded-[4px] border border-bazooka-lime bg-bazooka-lime px-5 sm:px-6 text-[9px] font-black uppercase text-black transition-all duration-300 hover:bg-bazooka-lime-hover active:scale-[0.97] active:bg-bazooka-lime-pressed";
