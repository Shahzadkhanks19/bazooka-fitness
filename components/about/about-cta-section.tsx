...
const points = ["Explore the training floor", "Meet the Bazooka team", "Compare membership options"] as const;
    ...
    <section className="relative overflow-hidden border-b border-bazooka-border/70 py-14 sm:py-16">
      ...
      <motion.div {...reveal} className={`${shell} relative grid gap-8 md:grid-cols-[1fr_auto] md:items-center md:gap-12`}>
        <div className="min-w-0">
          ...
          <h2 className="font-display mt-3 text-[35px] font-black uppercase leading-[.94] sm:text-[43px]">Ready To Experience<br /><span className="text-bazooka-lime">Bazooka For Yourself?</span></h2>
          <p className="mt-4 max-w-[520px] text-[10px] leading-5 text-bazooka-text-secondary sm:text-[11px]">Visit the club, explore the training floor and speak with the team before choosing the membership that suits you.</p>
