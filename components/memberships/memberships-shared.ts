...
export const buttonBase = "group inline-flex h-11 items-center justify-center gap-4 rounded-[4px] border px-5 sm:px-6 text-[10px] font-black uppercase tracking-[0.01em] transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0";
...
export const outlineButton = `${buttonBase} border-bazooka-border-strong bg-black/30 text-white hover:border-bazooka-lime hover:text-bazooka-lime`;
