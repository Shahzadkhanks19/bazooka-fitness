...
const trustItems = [
  [ShieldCheck, "Free Trial", "No payment required to book"],
...
const steps = [
  ...
  ["3", "Review Your Details", "Check your contact details, date and time before you continue."],
...
export default function FreeTrialPage() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (ageNumber !== null && (!Number.isInteger(ageNumber) || ageNumber < 1 || ageNumber > 120)) { setFormError("Please enter a valid age, or leave age blank."); return; }
    ...
    <section className="relative min-h-[560px] overflow-hidden border-b border-bazooka-border/70 bg-[url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=1800&q=90')] bg-cover bg-[62%_center] sm:bg-center">
      ...
      <div className={`${shell} relative z-10 flex min-h-[560px] items-center py-12 sm:py-14`}>
        <div className="max-w-[650px] min-w-0">
          ...
          <p className="mt-5 max-w-[530px] text-[11px] leading-6 text-bazooka-text-secondary sm:text-[12px]">Book a free trial, explore the training environment, meet the team and decide whether Bazooka Fitness is the right fit for you.</p>
