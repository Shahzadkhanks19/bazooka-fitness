...
const trialTimes = [
  { label: "05:30 AM - 08:00 AM", endMinutes: 8 * 60 },
  { label: "08:00 AM - 11:00 AM", endMinutes: 11 * 60 },
  { label: "04:00 PM - 07:00 PM", endMinutes: 19 * 60 },
  { label: "07:00 PM - 10:00 PM", endMinutes: 22 * 60 },
] as const;
...
export default function FreeTrialPage(){
  ...
  const handleDateChange = (value: string) => {
    ...
    if (value === minDate) {
      ...
      if (selected && selected.endMinutes <= currentMinutes) setPreferredTime("");
    }
  };
